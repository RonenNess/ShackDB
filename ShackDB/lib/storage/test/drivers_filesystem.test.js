/**
 * Test the filesystem drivers class.
 * |-- copyright and license --|
 * @package    ShackDB
 * @file       drivers_filesystem.test.js
...
const FilesystemDrivers = require('../lib/drivers/drivers_filesystem');


describe('FilesystemDrivers', function() 
{
    generateDriversTest(() => new FilesystemDrivers(), 'FilesystemDrivers');
});
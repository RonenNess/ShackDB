/**
 * Import all storage module tests.
...
require ('./validate_storage_id.test');
require ('./drivers_filesystem.test');
require ('./drivers_cached_filesystem.test');
require ('./drivers_memory.test');
require ('./storages_manager.test');
require ('./storage.test');
require ('./storage_policies.test');
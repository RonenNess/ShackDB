/**
 * Test the ram drivers class.
 * |-- copyright and license --|
 * @package    ShackDB
 * @file       drivers_memory.test.js
...
const RamDrivers = require('../lib/drivers/drivers_memory');


describe('RamDrivers', function() 
{
    generateDriversTest(() => new RamDrivers(), 'RamDrivers');
});
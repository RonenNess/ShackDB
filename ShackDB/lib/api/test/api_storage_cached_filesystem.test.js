/**
 * Test the storage api for filesystem storage.
 * |-- copyright and license --|
 * @package    ShackDB
 * @file       api_storage_cached_filesystem.test.js
 ...
 * 
 */
const generateStorageApiTests = require('./api_storage_base.test');
const config = require('../../config');


// test storage api with filesystem drivers
describe(config.server.apiUrl, function() 
{
    describe('storages/cached_files/', function() 
    {
        generateStorageApiTests('cached_files');
    });
});

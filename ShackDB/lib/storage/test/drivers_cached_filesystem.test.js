/**
 * Test the cached filesystem drivers class.
 * |-- copyright and license --|
 * @package    ShackDB
 * @file       drivers_cached_filesystem.test.js
...
const generateDriversTest = require('./drivers_base.test');
const CachedFilesystemDrivers = require('../lib/drivers/drivers_cached_filesystem');


describe('CachedFilesystemDrivers', function() 
{
    generateDriversTest(() => new CachedFilesystemDrivers({"timeToFlushSeconds": 2}), 'CachedFilesystemDrivers');
});
...
const ApiStorage = require('./api_storage');
...
class ApisManager
{
    ...
    setupRoutes(app)
    {
        logger.info("Setup all application routes.");
        ApiUsers.setupRoutes(app);
        ApiAuth.setupRoutes(app);
        ApiStorage.setupRoutes(app);
    }

    /**
     * Invoke all cleanup methods.
     */
    cleanup()
    {
        ApiUsers.cleanup();
...
// export main class
module.exports = new ApisManager();
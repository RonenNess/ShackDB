...
require ('./api_users.test');
require ('./api_auth.test');
require ('./api_storage_filesystem.test');
require ('./api_storage_ram.test');
require ('./api_storage_cached_filesystem.test.js')
require ('./api_storage_access.test.js');
require ('./api_performance.test.js');